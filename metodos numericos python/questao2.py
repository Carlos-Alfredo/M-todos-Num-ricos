tabela = [[1,-150,-175,250,0,0,0,0,0,0],[0,7,11,15,1,0,0,0,0,154],[0,10,8,12,0,1,0,0,0,80],[0,1,0,0,0,0,1,0,0,9],[0,0,1,0,0,0,0,1,0,6],[0,0,0,1,0,0,0,0,1,6]]
colunas = ["Z","A","B","C","S1","S2","S3","S4","S5","Solução"]
linhas = ["Z","S1","S2","S3","S4","S5"]
n_colunas=10
n_linhas=6
